defmodule CloudHub.Repo.Migrations.AddHasMany do
  ...
  def up do
    "ALTER TABLE feed_subscriptions DROP CONSTRAINT IF EXISTS feed_subscriptions_topic_id_fkey"
    |> execute()
    ...
    "ALTER TABLE feed_updates DROP CONSTRAINT IF EXISTS feed_updates_topic_id_fkey"
    |> execute()
    ...
    "ALTER TABLE feed_subscription_updates DROP CONSTRAINT IF EXISTS feed_subscription_updates_update_id_fkey"
    |> execute()

    "ALTER TABLE feed_subscription_updates DROP CONSTRAINT IF EXISTS feed_subscription_updates_subscription_id_fkey"
    |> execute()
